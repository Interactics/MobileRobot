...
float* Meca4WD::ForKinematics(float* wheelVelocity){
    ...
    twistVelocity[Vx]     = ( wheelVelocity[FR_LEFT] + wheelVelocity[FR_RIGHT] + wheelVelocity[BA_LEFT] + wheelVelocity[BA_RIGHT]) / 4;
    twistVelocity[Vy]     = (-wheelVelocity[FR_LEFT] + wheelVelocity[FR_RIGHT] - wheelVelocity[BA_LEFT] + wheelVelocity[BA_RIGHT]) / 4;
    twistVelocity[Wtheta] = (-wheelVelocity[FR_LEFT] - wheelVelocity[FR_RIGHT] + wheelVelocity[BA_LEFT] + wheelVelocity[BA_RIGHT]) / float(4 * (trackDist + wheelBase));
